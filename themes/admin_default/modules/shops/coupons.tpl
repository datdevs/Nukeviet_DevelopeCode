...
<div>
	<a class="btn btn-primary vuj-btn-excel-import" href="{LINK_IMPORT}"><i class="fa fa-file-excel-o" style="margin-right:10px"></i>Thêm danh sách mã giảm giá</a>
</div>
<br>
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<input class="form-control" type="text" name="discount" value="{ROW.discount}" required="required" oninvalid="setCustomValidity( nv_required )" oninput="setCustomValidity('')">
