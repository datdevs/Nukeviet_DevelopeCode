...
<div id="detail">
    ...
    <p>
        <strong>{LANG.category}:</strong><a href="{DATA.cat_link}" title="{DATA.cat_title}"> {DATA.cat_title}</a>
    </p>
    ...
    <p>
        <strong>{LANG.price}:</strong> <span class="price"> <!-- BEGIN: price -->{DATA.price}<!-- END: price --> <!-- BEGIN: contact -->{LANG.contact}<!-- END: contact -->
        </span>
    </p>
