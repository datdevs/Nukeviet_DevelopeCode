        ...
        <div class="panel-body">
            ...
            <div class="item-detail">
                <ul>
                    ...
                    <li><label><em class="fa fa-area-chart">&nbsp;</em>{LANG.area}:</label> <!-- BEGIN: area --> {blocknew_items.area} m<sup>2</sup> <!-- END: area --> <!-- BEGIN: size --> <!-- BEGIN: content --> {blocknew_items.size_h} x {blocknew_items.size_v} m <!-- END: content --> <!-- END: size --></li>
