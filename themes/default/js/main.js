...
function checkWidthMenu() {
  ...
  NVIsMobileMenu ? ($('li.dropdown ul').removeClass('dropdown-menu'), $('li.dropdown ul').addClass('dropdown-submenu'), $('li.dropdown a').addClass('dropdown-mobile'), $('#menu-site-default ul li a.dropdown-toggle').addClass('dropdown-mobile'), $('li.dropdown ul li a').removeClass('dropdown-mobile')) : ($('li.dropdown ul').addClass('dropdown-menu'), $('li.dropdown ul').removeClass('dropdown-submenu'), $('li.dropdown a').removeClass('dropdown-mobile'), $('li.dropdown ul li a').removeClass('dropdown-mobile'), $('#menu-site-default ul li a.dropdown-toggle').removeClass('dropdown-mobile'))
}

function checkAll(a) {
  $('.checkAll', a).is(':checked')
