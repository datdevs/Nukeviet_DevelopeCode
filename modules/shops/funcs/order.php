...
// VujiTech coupons
if (isset($_SESSION[$module_data . '_coupons']['check']) and $_SESSION[$module_data . '_coupons']['check'] == 1 and isset($_SESSION[$module_data . '_coupons']['discount'])) {
...
if ($nv_Request->isset_request('postorder', 'post')) {
    ...
    foreach ($_SESSION[$module_data . '_cart'] as $pro_id => $info) {
        ...
        if ($_SESSION[$module_data . '_cart'][$proid]['order'] == 1) {
            ...
            $total_weight = $total_weight + nv_weight_conversion((float) $info['weight'], $info['weight_unit'], $pro_config['weight_unit'], (int) $info['num']);
