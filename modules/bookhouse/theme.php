 ...
 *
 */
function nv_theme_viewcat($array_data, $generate_page = '', $viewtype = 'viewlist')
{
...
{
    global $global_config, $module_name, $module_file, $module_upload, $lang_module, $lang_global, $module_config, $module_info, $array_cat, $listroom, $client_info, $my_footer, $array_config, $array_way, $array_legal, $array_money_unit, $location_array_config;
    ...
    if (!empty($data_others)) {
        $hmtl = nv_theme_viewhome($data_others);
 ...
 *
 */
function nv_theme_bookhouse_search($array_data, $is_search, $generate_page, $viewtype = 'viewlist')
{
