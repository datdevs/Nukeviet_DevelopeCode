...
if (!nv_function_exists('nv_block_bookhouse_user_groups')) {
    ...
    {
        global $db, $global_config, $lang_module, $module_name, $module_data, $user_info, $module_info, $module_name, $array_config;

        if (!defined('NV_IS_USER') || empty($array_config['payport'])) {
            return '';
        }
