...
if (!nv_function_exists('nv_block_groups_items')) {
    ...
    {
        global $module_array_cat, $site_mods, $module_info, $db, $db_config, $module_config, $global_config, $array_config, $nv_Cache, $module_name, $lang_module, $nv_Request, $my_head;
        ...
        if (($cache = $nv_Cache->getItem($module, $cache_file)) != false) {
            ...
            $db->sqlreset()
                ->select('t1.id, catid, title, alias, homeimgfile, homeimgalt, homeimgthumb, price, price_time, money_unit, size_v, size_h, provinceid, districtid, wardid')
